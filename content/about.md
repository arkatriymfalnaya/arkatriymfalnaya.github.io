...
<div class="about-page">
    ...
    двигаюсь в сторону связки своих навыков с утопичными мнениями о справедливости и человеческом счастье. боюсь растерять альтруиста внутри себя и так и не раскрыть свой потенциал

    работаю с reactjs/solidjs, redux/mobx/logux, html/css/js/ts, nextjs, nodejs/nestjs, rust, codex/cursor/opencode и др. разрабатывал проекты из разных сфер — от adtech и retailtech до saas-платформ, участвовал в редизайнах систем, миграции на новые стеки и оптимизации ui-решений

    открыт к предложениям [brag doc](/brag/)
